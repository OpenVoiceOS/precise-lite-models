...
|------------------|------------------------------------------|--------------------------------------------------------------------------------|--------|------------|-------------|--------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| hey_mycroft_mk1  | proprietary MycroftAI (user opt-in data) | hundreds of hours of youtube audio                                             | 6000   | 5000       | 0.8         | 0.2    | model for the Mark I - 114,000 'hey mycroft' wake word samples, data collected via previous pocketsphinx wakeword and tagged via crowdsourcing in a WebUI |
